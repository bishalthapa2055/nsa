...
import { verifyOtpArenaControllerHandler } from "../../../../controllers/auth/arena/verifyOtp.controller";
...
router.post(
    ...
    validateRequest,
    verifyOtpArenaControllerHandler
)

export { router as verifyOtpArenaRouter}